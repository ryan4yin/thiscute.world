...
> Completely and utterly unacceptable. Imagine havinga tool that can't even properly undo an operation and then relying on it to manage an operating system.
> `apt`, `pip`, `pm`, `rpm`, `pacman`, whatever are alla mad fucking joke.
