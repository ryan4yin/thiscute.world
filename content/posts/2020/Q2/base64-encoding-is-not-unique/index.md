...
这让我觉得很奇怪（难道我发现了一个 Bug？），在 QQ 群里一问，就有大佬找到根本原因：**这是 Base64 编码的特性**。并且通过 python 进行了实际演示：
...
要解答这个问题，我们得看 base64 的定义。在 [RFC4648][RFC4648 - base64 定义] 的 base64 定义中，有如下这样一段话：
...
查阅 [RFC4648][RFC4648 - base64 定义] 第 4 小节中 base64 的定义，能看到它实际上是每次处理 24 bits，因为这是 6 和 8 的最小公倍数，可以刚好用 4 个字符表示。
