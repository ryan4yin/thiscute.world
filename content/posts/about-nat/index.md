...
date: 2022-05-08T16:04:00+08:00
draft: true
...
回环 NAT(Loopback NAT)，也被称作发夹 NAT(Hairpin NAT)，是指 NAT 穿透的一种特殊情况：P2P 连接的双方都在同一内网内，然后它们正在通过 NAT 网关使用公网 IP 通信。

对于不支持回环 NAT 的网关设备而言，这样的尝试将会失败！
