...
![](/images/process-thread-coroutines-concurrency-parallelism/cthreads-vs-processes.png)
...
一张图说明两者的差别
![](/images/process-thread-coroutines-concurrency-parallelism/concurrency-vs-parallelism.png)
