...
![](/images/web-browser-dev-tools/968138-20190211093455289-773908727.png)

![](/images/web-browser-dev-tools/968138-20190211150559673-23181676.png)

#### 2. copy

在 Chrome 中右键某个请求，选中 copy，会给出几个 options：

![](/images/web-browser-dev-tools/968138-20190211134155594-369771298.png)

而 Firefox-Dev 的更强一点，可以复制消息头（请求头和响应头）：

![](/images/web-browser-dev-tools/968138-20190211134845686-1048423446.png)

#### 3. response 的 pretty print

Chrome 的 Response 页面左下角，有`{}`按钮，可以 beautify 响应。

![](/images/web-browser-dev-tools/968138-20190211145915794-1971618603.png)
 
而 Firefox-Dev 只在 Debugger 页面提供该按钮，Response 中不支持。

Firefox 响应的 preview 和 payload 是放在 Response 页面下。而 Chrome 是分成了两个标签页

![](/images/web-browser-dev-tools/968138-20190211150146579-1141462696.png)

![](/images/web-browser-dev-tools/968138-20190211150217505-933154713.png)
...
![](/images/web-browser-dev-tools/968138-20190211142152309-1418680644.png)

Chrome 不能查看 HTTP/2 的 Raw Headers。

![](/images/web-browser-dev-tools/968138-20190211142301777-1440991898.png)

而 Firefox 则支持查看 HTTP/2 的 Raw Headers。（是恢复后的，HTTP/2 的原始消息头是二进制压缩形式）

![](/images/web-browser-dev-tools/968138-20190211142424361-986461531.png)

它还提供 Edit and Resend 请求的功能，这点要给个赞～

![](/images/web-browser-dev-tools/968138-20190211172845339-1004306694.png)
...
![](/images/web-browser-dev-tools/968138-20190211161734224-864236086.png)

#### 7. 跨页面加载时，保留网络请求记录

当页面重载或者页面跳转时，默认情况下，Network面板下的网络请求记录表也是刷新的。如果想保留之前页面的网络请求数据，可以勾选Preserve log.

![](/images/web-browser-dev-tools/968138-20190211191616024-1591891666.png)
...
![](/images/web-browser-dev-tools/968138-20190211151856683-1227556897.png)
...
![](/images/web-browser-dev-tools/968138-20190211152916189-42263251.png)

#### 2. 检索元素上注册的事件（Chrome only）

在 Elements 页面选中一个元素（或者直接右键检查该元素），然后在右侧窗口，选择 Event Listeners 标签，就可以看到该元素上注册的所有事件。

![](/images/web-browser-dev-tools/968138-20190211154036983-2040723318.png)
...
![](/images/web-browser-dev-tools/968138-20190211160511912-2063790850.png)
...
1. 条件断点
    ...
    ![](/images/web-browser-dev-tools/968138-20190211154841386-1840257581.png)
...
![](/images/web-browser-dev-tools/968138-20190212163124375-995667384.png)
...
![](/images/web-browser-dev-tools/968138-20190211102530072-2093584274.png)

#### 2. For Firefox

1. 只截显示出来的部分：和 Chrome 一样点击设备图标，然后在页面上面的 toolbar 就有截图按钮
2. ![](/images/web-browser-dev-tools/968138-20190211163703764-1641229843.png)
3. 截网页全图：在 DevTools 右边的 options 中进入 Settings，勾选 `take a screenshot of the entire page`，DevTools 右上角就会出现截图按钮了。

![](/images/web-browser-dev-tools/968138-20190211163941562-1320561581.png)
...
![](/images/web-browser-dev-tools/968138-20190211161131091-420638637.png)
...
![](/images/web-browser-dev-tools/968138-20190211170346973-560763838.png)
...
![](/images/web-browser-dev-tools/968138-20190211170804371-405922156.png)

### 3. Request Blocking（Chrome only）

在 Network 的任意请求上右键，菜单中就有 Block request URL（阻塞该 URL）和 Block request domain（阻塞请求所在的整个域）

![](/images/web-browser-dev-tools/968138-20190211171736248-156227886.png)

然后就可以在 More tools -> Request blocking 中看到你设置的阻塞条件。

![](/images/web-browser-dev-tools/968138-20190211172032733-566193435.png)
